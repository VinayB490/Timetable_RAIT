...
<body><center><b>
  <a name="top"></a>
<form  name="fload" action="load.php" method="post" >
<table>
<tr >
...
<tr>
<td>Course Name:</td>
<td><input type="text" name="lcourse" required placeholder="Enter Course Name"></td>
...
<td><input type="text" name="ltname" required placeholder="Enter Teacher Name"></td>
</tr>
<tr >
        <td colspan="2">  </td>
      </tr>
...
<?php
          ...
          <td><a href="load.php?edit=<?php echo $course; ?>"><img src="edit.png" width="20" height="20" align="center"></a></td>
          <td><a href="load.php?delete=<?php echo $course; ?>"><img src="del.png" width="20" height="20" align="center"></a></td>
        </tr>
      <?php
      } ?>
</table>
